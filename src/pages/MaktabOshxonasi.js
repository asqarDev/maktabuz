            ...
            <Col lg={11}>
              <Row>
                ...
                <Col
                  ...
                  md={12}
                  sm={12}
                  className={styles.maktabTushlik}
                  data-aos="zoom-in-up"
                >
              ...
              <Row>
                ...
                >
                  <h1
                    style={{ fontSize: "70px", fontFamily: "Lobster" }}
                ...
                <Col lg={4} md={6} sm={12}>
                  <div className={styles.card2} data-aos="zoom-in-up">
                    <p>
                      ...
                      oziqlanishning yangi standartlari maktablardan Milliy
                      Maktab Tushlik Dasturi orqali beriladigan donli don, meva
                      va sabzavotlarni ko'paytirilishini talab qildi.
                    </p>
                  </div>
                </Col>
              </Row>
          ...
          <Row>
            <Col lg={2} md={4} sm={6}>
              <Row>
                ...
                <Col lg={12}>
                  <div className={styles.cardMenyu}></div>
                </Col>
                <Col lg={12}>
