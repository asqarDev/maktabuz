...
const { Option } = Select;
export default class SinfBaholar extends Component {
    state = {
        sinf: '9',
        searchText: '',
    searchedColumn: '',
...
davomad:[
  ...
  handleReset = clearFilters => {
    ...
    return (
      <div>
        ...
        <Select
    showSearch
    style={{ width: '50%', display:'block', margin:'auto', fontSize:'18px' }}
  ...
  >
    <Option value="1">Ismoilov Rahmon Zohid o'g'li</Option>
    <Option value="2">Ismoilov Rahmon Zohid o'g'li</Option>
    <Option value="3">Ismoilov Rahmon Zohid o'g'li</Option>
    <Option value="4">Ismoilov Rahmon Zohid o'g'li</Option>
    <Option value="5">Ismoilov Rahmon Zohid o'g'li</Option>
    <Option value="6">Ismoilov Rahmon Zohid o'g'li</Option>
  </Select><br/><br/><br/>
