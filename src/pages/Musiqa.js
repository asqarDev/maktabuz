    ...
    return (
      <div>
        ...
        <Container className={styles.galereya}>
          <Row>
            <Col lg={12}>
              <h1 className={styles.galereyaText} data-aos="zoom-in-up">
                Murabbiylar
              </h1>
            </Col>
            ...
            <Col lg={4} md={6} sm={12}>
              ...
              >
                <div
                  className={(styless.card, styless.cardone)}
                  style={{
                ...
                >
                  ...
                  <div className={styless.desc}>
                    ...
                    <p>
                      O'zbekiston Respublikasi chempioni,Yoshlar orasida
                      yetakchi murabbiy
                    </p>
            ...
            {this.state.sports.map((item, key) => {
              return (
                <Col
                  ...
                  md={6}
                  sm={6}
                  className={styless.containerKonkurslar}
                >
                  <div
                    data-aos="zoom-in-up"
                    className={styless.cardsKonkurslar}
                  >
                    <h2>{item.title}</h2>
